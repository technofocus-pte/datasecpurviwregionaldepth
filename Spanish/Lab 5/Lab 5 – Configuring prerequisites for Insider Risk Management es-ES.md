...
5.  En la ventana de inicio de sesión, inicie sesión con las
    credenciales de **administrador de MOD** que aparecen en la pestaña
...
6.  Pulse Make sure this is your organisation.
...
9.  Vaya a la máquina recién creada, **Pattis-Device** , seleccione
...
11. Puede abrir los archivos RDP y utilizar las siguientes credenciales
...
12. Abra el archivo RDP para **Pattis -Device** e inicie sesión con las
    credenciales locales.

13. Abra Windows **Settings** en su recién creada VM llamada **Patti's**
    **Device**.

![A screenshot of a computer Description automatically
generated](./media/image14.png)

14. Vaya a **Accounts** \>**Access work or school**.

![A screenshot of a computer Description automatically
generated](./media/image15.png)

15. En **Access work or school account**, haga clic en **Connect**.

![A screenshot of a computer Description automatically
generated](./media/image16.png)

16. En la ventana de **Set up a work or school account**, haga clic
    en **Join this device to** **Microsoft Entra ID**.
...
19. En la ventana de inicio de sesión, inicie sesión con el nombre de
    usuario **pattif@WWL xXXXXXX .onmicrosoft.com** y la contraseña de
    usuario . (sustituya WWL xXXXXXX por el prefijo de su tenant que
    figura en la pestaña de recursos ).

20. 

21. Pulse **Join** en el mensaje **Make sure this is your
    organisation**.
...
23. Una vez hecho verás una ventana de confirmación **You’re all set!**.
    Haga clic en Done.

![](./media/image35.png)

24. Una vez más cerca de **Access work or school**, haga clic en
    **Connect** .
...
27. En la ventana Set up a work or school account, inicia sesión con el
...
28. Tardará un par de minutos en registrarse.

![A screenshot of a computer Description automatically
generated](./media/image41.png)

29. Aparecerá un mensaje: " **Setting up your account** ". Pulse **Got
    it**.

![Graphical user interface, text, application, Word Description
automatically generated](./media/image42.png)

30. En su página **Settings \>Accounts \>Access work or school** verá la
    cuenta de Patti Fernandez conectada dos veces. Expanda la que dice
    **Connected to Contoso MDM.**

![](./media/image43.png)

31. Haga clic en **Info** .

![](./media/image45.png)

32. En **Settings** \>**Accounts** \>**Access work or school**
    \>**Managed by Contoso**, en **Device sync status**, haga clic en
    **Sync** .

![](./media/image46.png)

33. Una vez hecho esto, cierre la **Settings** y, desde la ventana de
    inicio, **reinicie** el PC. Asegúrese de no apagarlo.

![A screenshot of a computer Description automatically generated with
medium confidence](./media/image47.png)

34. Abra de nuevo el archivo RDP. Haga clic en **More choices**.

![A screenshot of a computer security Description automatically
generated with medium confidence](./media/image48.png)

35. Haga clic en **Use a different account**.
...
38. Inicie sesión con el nombre de usuario **pattif@WWLxXXXXXX
    .onmicrosoft.com** y la contraseña de usuario. (sustituya WWLxXXXXXX
    por el prefijo de su tenant que aparece en la pestaña de recursos )
    . Si se le pide confirmación, haga clic en **Yes**.

39. 

40. Abra el archivo RDP del dispositivo de Adele y siguiendo los mismos
    ...
    sesión, inicie sesión con el nombre de usuario **adelev** **@WWL
    xXXXXXX.onmicrosoft.com** y la contraseña de usuario (sustituya WWL
    xXXXXXX por el prefijo de su inquilino indicado en la pestaña de
    recursos).

41. 

42. Abra el archivo RDP del dispositivo de Christie y siguiendo los
    ...
    sesión, inicia sesión con el nombre de usuario **christiec** **@WWL
    xXXXXXX.onmicrosoft.com** y la contraseña de usuario (sustituye
    WWLxXXXXXX por el prefijo de tu tenant que aparece en la pestaña de
    recursos).
