...
utilizando las políticas de Insider Risk Management. Utilizaremos los{TENANTPREFIX}
...
2.  En la barra de navegación , seleccione **Settings**, y seleccione **Role  groups** en **Role
...
4.  Seleccione la casilla situada cerca de **Megan** y **Alex**. A
...
7. Seleccione **Done** para completar los pasos.
...
1.  En el portal Microsoft Purview . Vaya a **Settings**, vaya a
...
7.  Cierre el centro de seguridad y el centro de actualización. Finalice
    la conexión RDP por ahora.

8.  Repita los pasos del 1 al 7 para actualizar **Adeles-Device** y
    **Christies-Device**.

9. Inicie sesión en **```https://security.microsoft.com/```**
    utilizando su cuenta de **MOD Administrator** en su VM de
    laboratorio .

10. Seleccione **Settings** \> **Device** **onboarding**.

![](./media/image27.png)

11. Haga clic en **Turn on Device onboarding**.

![A screenshot of a computer Description automatically
generated](./media/image29.png)

12. Desde los **settings** \> **Device onboarding** \> **Onboarding**.
    Haga clic en **Download package**.

![A screenshot of a computer Description automatically
generated](./media/image30.png)

13. Una vez descargado, conéctese a **Pattis-Device** mediante RDP y
    copie el archivo en el escritorio de **Pattis** -Device.

14. Haga clic con el botón derecho en el archivo y **Extract all...**.
...
15. Una vez hecho esto, abra la carpeta y ejecute el archivo con
    derechos de **Administrator**.

![A computer screen with a computer screen Description automatically
generated](./media/image35.png)

16. Haga clic en **More info**.

![Graphical user interface, application Description automatically
generated](./media/image36.png)

17. Haga clic en **Run anyway**.

![A screenshot of a computer error Description automatically
generated](./media/image37.png)

18. En el Command prompt, pulse **Y** y pulse **Enter** para confirmar y
    continuar cuando se le solicite.

![A screenshot of a computer error Description automatically
generated](./media/image38.png)

19. Recibirá un mensaje indicando que el dispositivo está integrado. En
    el Command Prompt una vez que reciba el mensaje, **Press any key to
    continue. . .**, pulse cualquier tecla.

20. Una vez cerrado el símbolo del sistema, abra Símbolo del sistema en
...
21. Cierre la conexión VM.

22. Si el onboarding del dispositivo se realiza correctamente, puede ir
...
23. Ahora copie el archivo que descargamos en el paso 13, y repita los
    pasos 15 a 21 para las VMs - **Adeles-Device** y **Christies-Device**,
    respectivamente para incorporarlos como Devices en el portal de
    **Microsoft 365 Defender** .

24. Abra la página **```https://purview.microsoft.com```** e inicie
    sesión con el nombre de usuario **pattif@{TENANTPREFIX}.onmicrosoft.com** y la contraseña de
    usuario . (sustituya {TENANTPREFIX} por el prefijo de su tenant que
    aparece en la pestaña de recursos).

25. Abra la **configuración de** haciendo clic en la configuración en la
...
26. Podrá comprobar la lista de **Devices**. La lista estará vacía hasta
...
1.  Si ha cerrado la ventana del navegador en la tarea anterior, abra la
    ...
    **pattif@{TENANTPREFIX}.onmicrosoft.com** y la contraseña de usuario .
    (sustituye {TENANTPREFIX} por el prefijo de tu tenant que aparece en la
    pestaña de recursos).
...
3.  En la página **Choose a policy template**, seleccione **General risky
...
4.  Utilice el campo **Search user to add to policies**. Añada a Patti,
    Adele y Christie. A continuación, haga clic en Start scoring activity.
...
3.  En la página **Choose a policy template** , seleccione **Data theft
...
8.  En la página **Sensitivity labels to prioritize**, seleccione **Add
...
9.  En la página **Sensitive info types to prioritize page**,
...
10.  En **Decide whether to score only activity with priority content**,
    seleccione **Get alerts for all activity**. Seleccione **Next**.

![A screenshot of a computer screen Description automatically generated
with medium confidence](./media/image73.png)

11.  En la página **Triggers for this policy**, seleccione **Default** y,
    a continuación, **Next**.

![A screenshot of a computer Description automatically generated with
medium confidence](./media/image74.png)

12.  En la página **Indicators**, seleccione **Turn on indicators**.

![A screenshot of a computer Description automatically generated with
medium confidence](./media/image75.png)

13. Seleccione **Select all** en **Office indicators** y haga clic en
    **Save**.

![A screenshot of a computer screen Description automatically generated
with medium confidence](./media/image76.png)

14. Seleccione todas las opciones y haga clic en **Next**.

![A screenshot of a computer Description automatically
generated](./media/image77.png)

15. En la página **Detection options**, seleccione la opción
    predeterminada y, a continuación, **Next**.

![A screenshot of a computer Description automatically
generated](./media/image78.png)

16. En la página de **Indicators**, seleccione **Next**.
...
4.  Utilice el campo **Search User** para añadirlo a las políticas.
    Añada a Adele. A continuación, haga clic en **Start scoring
    activity**.
...
7.  En la página **Decide whether to prioritize**, seleccione **I want
    to specify priority content**. Seleccione la casilla de verificación
   **SharePoint sites**, **Sensitivity labels** y** Sensitive Info types**.
...
8.  En la página **SharePoint sites to prioritize**, seleccione **Add or
    ...
    ://{TENANTPREFIX} .sharepoint.com/sites /ContosoWeb1** y seleccione **Add**.
...
2.  En el campo **Reason** del panel **Add users to multiple policies**,
    ...
    campo **Search user to add to policies**. Añada a Patti, Adele y
    Christie. A continuación, haga clic en **Start scoring activity**.
