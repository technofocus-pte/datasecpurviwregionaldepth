...
2.  In the navigation select **Settings**, and select **Role groups** under **Roles and scopes**, select **Communication
...
2.  In the Microsoft Purview portal, select **Solutions** \>
